...
import { heart, home, personCircleOutline, chevronForwardOutline, addOutline } from 'ionicons/icons';
...
export class DetailsPage implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private router: Router, private mhs: MyHttp) { 
    addIcons( {heart, home, personCircleOutline, chevronForwardOutline, addOutline} );
  }
